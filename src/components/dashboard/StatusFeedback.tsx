      ...
      {(["Ongoing", "Stalled", "Completed"] as const).map((status) => {
        ...
        return (
          ...
          >
            {/* Group Header */}
            <div
              className={`flex items-center gap-2 px-4 py-3 border-b border-border ${meta.bg}`}
            >
                ...
                {items.map((p) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {/* Expanded: detail + feedback */}
                      {isExpanded && (
                        <div
                          id={`feedback-${p.id}`}
                          className="px-4 pb-4"
                          style={{ animation: "feedback-expand 0.2s ease" }}
                        >
                          {/* Project meta strip */}
                          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 mb-3">
                            {[
                              {
                                label: "Budget",
                                value: `KES ${Number(p.budget).toLocaleString()}`,
                              },
                              ...
                              <div
                                key={label}
                                className="bg-muted/40 rounded-lg px-3 py-2 col-span-1 last:col-span-2 sm:last:col-span-1"
                              >
